...
function bool PlayersNearby(){
    local DeusExPlayer dxp;
    
    foreach VisibleActors(class'DeusExPlayer', dxp, visRange){
        if(dxp != None) return True;
    }
}
...
defaultproperties
{
     ...
     BindName="resourceful rat"
     FamiliarName="resourceful rat"
     UnfamiliarName="resourceful rat"
}
